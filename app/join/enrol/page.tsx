      ...
      <div className="max-w-xl mx-auto">
        ...
        {step === 0 && (
          <div className="space-y-4">
            ...
            {/* Discount code */}
            <div>
              <p className={labelClass}>Discount Code <span className="text-gray-400 text-xs">(optional)</span></p>
              {accessCodeDiscount ? (
              ...
              {accessCodeError && <p className="mt-1.5 text-xs text-red-600">{accessCodeError}</p>}
            </div>
